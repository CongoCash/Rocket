# Using the Python language, have the function counting_minutes(str) take the str parameter being passed which will be
# two times (each properly formatted with a colon and am or pm) separated by a hyphen and return the total number
