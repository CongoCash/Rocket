# Using the Python language, have the function LookSaySequence(num) take the num parameter being passed
...
# being "one 1" before it and the 21 comes from there being "two 1's" before it.
# So your program should return the next number in the sequence given num.

# Ex: Input = 1211Output = 111221
# Ex: Input = 2466Output = 121426

def look_say_sequence():
	pass